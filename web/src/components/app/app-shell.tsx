...
import { BarChart3, CalendarDays, Home, Library, Menu, Quote, StickyNote, Target, Timer, X } from "lucide-react";
...
const mobile = nav.filter((item) => !["/app/quotes", "/app/notes", "/app/stats"].includes(item.href));
      ...
      <div className="min-w-0 lg:col-start-2">
        ...
        {menuOpen ? (
          <div className="fixed inset-x-4 top-[calc(4rem+env(safe-area-inset-top))] z-30 border border-line bg-panel p-2 shadow-[var(--shadow-lg)] lg:hidden">
            ...
            <Link className="flex min-h-12 items-center gap-3 px-3 text-sm" href="/app/stats" onClick={() => setMenuOpen(false)}><BarChart3 size={18} strokeWidth={1.5} />Statistics</Link>
