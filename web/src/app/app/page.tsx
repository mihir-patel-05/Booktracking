...
export default async function HomePage() {
  ...
  const [{ data: books }, { data: stats }, { data: monthSessions }, { data: finished }, { data: quotes }, { data: notes }] = await Promise.all([
    ...
    supabase.from("reading_sessions").select("session_local_date,duration_seconds").gte("session_local_date", monthStart).lte("session_local_date", today),
