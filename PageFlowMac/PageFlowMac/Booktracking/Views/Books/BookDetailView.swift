        ...
        ZStack {
            ...
            ScrollView {
                HStack(alignment: .top, spacing: 24) {
                    // Left column: cover + info + progress
                    VStack(spacing: 20) {
                        coverSection
                        infoSection
                        progressSection
                    ...
                    // Right column: sessions + notes + quotes
                    VStack(spacing: 20) {
                        sessionsSection
                        notesSection
                        quotesSection
    ...
    private var notesSection: some View {
        ...
        return VStack(alignment: .leading, spacing: 12) {
            ...
            if book.notes.isEmpty {
                ...
                ForEach(Array(sortedNotes.prefix(5))) { note in
                    NavigationLink {
    ...
    private var quotesSection: some View {
        ...
        return VStack(alignment: .leading, spacing: 12) {
            ...
            if book.quotes.isEmpty {
                ...
                ForEach(Array(sortedQuotes.prefix(5))) { quote in
